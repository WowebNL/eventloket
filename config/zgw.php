    ...
    'connections' => [
        ...
        'main' => [
            ...
            */
            ...
            // How zaakgeometrie is sent: 'json' (encoded string, legacy OpenZaak) or 'array'
            // (decoded GeoJSON object). RX Mission requires 'array'.
            'geometry_format' => env('ZGW_GEOMETRY_FORMAT', 'json'),
