...
return true || (false);
                ...
                FileUpload::make('veiligheidsplan')
                    ...
                    ->hidden(function (Get $get, $livewire) {
                        $rule = $livewire->state()->isFieldHidden('veiligheidsplan');
                        if ($rule === true) {
                            return true;
                        } if ($rule === false) {
                            return false;
...
return true || (false);
                ...
                FileUpload::make('bebordingsEnBewegwijzeringsplan')
                    ...
                    ->hidden(function (Get $get, $livewire) {
                        $rule = $livewire->state()->isFieldHidden('bebordingsEnBewegwijzeringsplan');
                        if ($rule === true) {
                            return true;
                        } if ($rule === false) {
                            return false;
...
return true || (false);
                ...
                FileUpload::make('bijlagen1')
                    ...
                    ->hidden(function (Get $get, $livewire) {
                        $rule = $livewire->state()->isFieldHidden('bijlagen1');
                        if ($rule === true) {
                            return true;
                        } if ($rule === false) {
                            return false;
