                        ...
                        Repeater::make('opWelkeLocatieOfLocatiesVindErOpvangVanDeKinderenOnder12JaarPlaats')
                            ...
                            ->schema([
                                Map::make('locatieVanOpvangVanDeKinderenOnder12Jaar')
                                    ...
                                    ->helperText('Klik op het markering-icoontje in de werkbalk en klik vervolgens op de kaart om een pin te plaatsen. Gebruik de prullenbak om een geplaatste markering te verwijderen.')
                                    ->required(),
                            ]),
                    ])
