...
final class AlsBoolEnIsN implements Rule
{
    ...
    {
        return (bool) (JsTruthy::of($s->get('eventloketSession.organisation_email')) && ($s->get('eventloketSession.organisation_email') !== 'None') && ($s->get('eventloketSession.organisation_address') !== 'NULL'));
    }
