...
namespace App\Filament\Shared\Resources\Zaken;
...
class ZaakResource extends Resource
{
    ...
    {
        return __('resources/zaak.label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('resources/zaak.plural_label');
    }
    ...
    {
        return [
            'index' => Pages\ListZaken::route('/'),
            'view' => Pages\ViewZaak::route('/{record}'),
        ];
    }
}
