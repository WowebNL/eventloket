...
use App\Filament\Municipality\Clusters\Settings\Resources\DefaultAdviceQuestions\Schemas\DefaultAdviceQuestionForm;
use App\Filament\Municipality\Clusters\Settings\Resources\DefaultAdviceQuestions\Tables\DefaultAdviceQuestionTable;
...
class DefaultAdviceQuestionResource extends Resource
{
    ...
    {
        return __('municipality/resources/default-advice-question.label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('municipality/resources/default-advice-question.plural_label');
    }
