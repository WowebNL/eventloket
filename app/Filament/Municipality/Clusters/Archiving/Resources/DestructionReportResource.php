                ...
                RepeatableEntry::make('items')
                    ...
                    ->schema([
                        ...
                        TextEntry::make('source')
                            ->label(__('municipality/resources/destruction_report.columns.source.label'))
                            ->visible(fn (?string $state): bool => filled($state))
                            ->formatStateUsing(fn (string $state): string => __("enums/zaak_destruction_source.{$state}.label")),
                    ]),
            ]);
    }
