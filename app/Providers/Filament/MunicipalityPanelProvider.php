        ...
        return $panel
            ...
            ->navigationItems([
                NavigationItem::make('newzaken')
                    ...
                    ->badge(fn (): int => Zaak::whereNull(['reviewer_user_id', 'reference_data->resultaat', 'imported_data'])->count())
                ...
                NavigationItem::make('workingstock')
                    ...
                    ->group(__('resources/zaak.plural_label'))
                    ->badge(fn (): int => Zaak::where('reviewer_user_id', auth()->id())->whereNull(['reference_data->resultaat', 'imported_data'])->count())
                    ->icon(Heroicon::Inbox)
