...
class AssignedToAdviceThread extends BaseNotification
{
    ...
    {
        return __('notification/assigned-to-advice-thread.label');
    }
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('notification/assigned-to-advice-thread.mail.subject', [
                'event' => $this->eventName,
                'municipality' => $this->municipalityName,
            ]))
            ->markdown('mail.assigned-to-advice-thread', [
    ...
    public function toDatabase(User $notifiable): array
    {
        return FilamentNotification::make()
            ->title(__('notification/assigned-to-advice-thread.database.title', [
                'event' => $this->eventName,
                'municipality' => $this->municipalityName,
            ]))
            ->actions([
