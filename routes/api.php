...
use App\Http\Controllers\Api\ValidateEventloketTokenController;
...
Route::group(['middleware' => [EnsureClientIsResourceOwner::class, NormalizeOpenformsInput::class]], function () {
    ...
    Route::get('/validate-eventloket-token', ValidateEventloketTokenController::class)->name('api.validate-eventloket-token');
