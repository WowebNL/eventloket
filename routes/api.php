...
Route::group(['middleware' => [EnsureClientIsResourceOwner::class.':api:access', NormalizeOpenformsInput::class]], function () {
...
Route::post('/open-notifications/listen', [OpenNotificationsController::class, 'listen'])
    ->middleware([EnsureClientIsResourceOwner::class.':notifications:receive', NormalizeOpenformsInput::class])
